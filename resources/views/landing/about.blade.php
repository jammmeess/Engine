<div class="container-fluid px-5" id="About">
    ...
    <div class="row text-light">
        ...
        <div class="col-12 d-block d-sm-none justify-text-center text-center">
            <h3 class="ms-3 my-1 display-6 text-light about-content">Embark on an incredible Journey with us!</h3>
            <p class="ms-3  text-light about-content">Engine_ emerged from a simple idea and has transformed into an extraordinary gaming ecommerce company. </p>
        </div>

        <div class="col-12 d-block d-sm-none justify-text-center text-center">
            <p class="ms-3  text-light about-content">Discover a curated collection of games, join a vibrant community, and unleash your passion. With an intuitive interface and exceptional service, we're here to make your gaming dreams a reality. </p>
